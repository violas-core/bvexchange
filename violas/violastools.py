...
args = {"help"                  :   "dest: show arg list. format: --help",
        ...
        "send_coin-"           :   "dest: send token(coin) to target address. format: --send_coin \"form_address, to_address, amount, module, data[default = None  ex: v2b:btc_address:<BTC ADDRESS>]\" ",
