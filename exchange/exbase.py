...
class exbase(baseobject):    
    ...
    def __init__(self, name, from_chain, map_chain):
    ...
    def exec_refund(self, data, from_sender):
        ...
        if self.from_chain.upper() == "BTC":
            ac = self.amountswap(amount, self.amountswap.amounttype.VIOLAS) # vbtc -> btc
            amount = ac.btc_amount
